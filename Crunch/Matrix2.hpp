...
namespace crunch
{
    ...
    public:
         ...
         */
        static inline Matrix2<T> identity();

        /**
         * @brief Returns a matrix with all elements initialized to zero.
         */
        static inline Matrix2<T> zero();

        /**
         * @brief Returns a rotation matrix.
         * @param _radians An angle in radians.
         */
        static inline Matrix2<T> rotation(T _radians);

        /**
         * @brief Returns a scaling matrix.
         * @param _scale Uniform scale factor.
         */
        static inline Matrix2<T> scaling(T _scale);

        /**
         * @brief Returns a scaling matrix.
         * @param _scale Scale vector.
         */
        static inline Matrix2<T> scaling(const Vector2<T> & _scale);
         ...
         */
        static inline Matrix2<T> scaling(T _x, T _y);
